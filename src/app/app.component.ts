...
export class AppComponent {
  ...
  industries=[
    [
      { code: 12, name: "娱乐设施" }, { code: 27895, name: "娱乐" }, { code: 32341, name: "运动" }, { code: 27895, name: "娱乐" }, { code: 32341, name: "运动" }, { code: 27895, name: "娱乐" }, { code: 32341, name: "运动" }, { code: 27895, name: "娱乐" }, { code: 32341, name: "运动" }, { code: 27895, name: "娱乐" }, { code: 32341, name: "运动" }, { code: 27895, name: "娱乐" }, { code: 32341, name: "运动" }, { code: 27895, name: "娱乐" }, { code: 32341, name: "运动" }, { code: 27895, name: "娱乐" }, { code: 32341, name: "运动" }, { code: 27895, name: "娱乐" }, { code: 32341, name: "运动" }, { code: 27895, name: "娱乐" }, { code: 32341, name: "运动" }, { code: 27895, name: "娱乐" }, { code: 32341, name: "运动" }, { code: 27895, name: "娱乐" }, { code: 32341, name: "运动" }
    ],[
  ...
  selectAllWeek(){
    this.wholeWeek==false ? this.vaildTime.map((item,index)=>{item.checked=true;}) : this.vaildTime.map((item,index)=>{item.checked=false});
  }
  selectThisDay(item){
